...
// End Cross Module References
	...
	DEFINE_FUNCTION(ACardDeck::execManualLoadDeck)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ManualLoadDeck();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(ACardDeck::execGetSavePath)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FString*)Z_Param__Result=P_THIS->GetSavePath();
		P_NATIVE_END;
	}
	...
	void ACardDeck::StaticRegisterNativesACardDeck()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetSavePath", &ACardDeck::execGetSavePath },
			{ "IsDeckEmpty", &ACardDeck::execIsDeckEmpty },
			{ "LoadDeck", &ACardDeck::execLoadDeck },
			{ "ManualLoadDeck", &ACardDeck::execManualLoadDeck },
	...
	struct Z_Construct_UFunction_ACardDeck_GetSavePath_Statics
	{
		struct CardDeck_eventGetSavePath_Parms
		{
			FString ReturnValue;
		};
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CardDeck_eventGetSavePath_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "CardDeck.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACardDeck, nullptr, "GetSavePath", nullptr, nullptr, Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::PropPointers), sizeof(Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::CardDeck_eventGetSavePath_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::Function_MetaDataParams), Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::CardDeck_eventGetSavePath_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ACardDeck_GetSavePath()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ACardDeck_GetSavePath_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_ACardDeck_ManualLoadDeck_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ACardDeck_ManualLoadDeck_Statics::Function_MetaDataParams[] = {
		{ "CallInEditor", "true" },
		{ "Category", "Deck Settings" },
		{ "ModuleRelativePath", "CardDeck.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ACardDeck_ManualLoadDeck_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ACardDeck, nullptr, "ManualLoadDeck", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ACardDeck_ManualLoadDeck_Statics::Function_MetaDataParams), Z_Construct_UFunction_ACardDeck_ManualLoadDeck_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_ACardDeck_ManualLoadDeck()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ACardDeck_ManualLoadDeck_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACardDeck_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ACardDeck_GetSavePath, "GetSavePath" }, // 3576362912
		...
		{ &Z_Construct_UFunction_ACardDeck_ManualLoadDeck, "ManualLoadDeck" }, // 3323287615
	...
	ACardDeck::~ACardDeck() {}
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_Cardslinger_Prototype_CardslingerPrototype_Source_CardslingerPrototype_CardDeck_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Cardslinger_Prototype_CardslingerPrototype_Source_CardslingerPrototype_CardDeck_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACardDeck, ACardDeck::StaticClass, TEXT("ACardDeck"), &Z_Registration_Info_UClass_ACardDeck, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACardDeck), 1031912857U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Cardslinger_Prototype_CardslingerPrototype_Source_CardslingerPrototype_CardDeck_h_504533670(TEXT("/Script/CardslingerPrototype"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_Cardslinger_Prototype_CardslingerPrototype_Source_CardslingerPrototype_CardDeck_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_Cardslinger_Prototype_CardslingerPrototype_Source_CardslingerPrototype_CardDeck_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
