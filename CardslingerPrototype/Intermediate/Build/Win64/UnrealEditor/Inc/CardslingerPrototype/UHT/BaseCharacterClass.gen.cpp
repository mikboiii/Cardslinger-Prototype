...
// End Cross Module References
	...
	DEFINE_FUNCTION(ABaseCharacterClass::execGetReflectionMode)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->GetReflectionMode();
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics
	{
		struct BaseCharacterClass_eventGetReflectionMode_Parms
		{
			bool ReturnValue;
		};
	...
	void Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((BaseCharacterClass_eventGetReflectionMode_Parms*)Obj)->ReturnValue = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(BaseCharacterClass_eventGetReflectionMode_Parms), &Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "BaseCharacterClass.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ABaseCharacterClass, nullptr, "GetReflectionMode", nullptr, nullptr, Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::PropPointers), sizeof(Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::BaseCharacterClass_eventGetReflectionMode_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::BaseCharacterClass_eventGetReflectionMode_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ABaseCharacterClass_GetReflectionMode_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseCharacterClass_Statics::NewProp_PauseAction_MetaData[] = {
		{ "Category", "Input" },
		{ "ModuleRelativePath", "BaseCharacterClass.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABaseCharacterClass_Statics::NewProp_PauseAction = { "PauseAction", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABaseCharacterClass, PauseAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ABaseCharacterClass_Statics::NewProp_PauseAction_MetaData), Z_Construct_UClass_ABaseCharacterClass_Statics::NewProp_PauseAction_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABaseCharacterClass_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseCharacterClass_Statics::NewProp_PauseAction,
